		...
		actions: {
			...
			mensaje: async (email,password)=>{
				try{
					...
					const resp= await fetch(`https://3001-4geeksacade-reactflaskh-ltnz14kay5a.ws-us77.gitpod.io/api/login`,
					{
						method:'POST',
						headers:{
			...
			protegido:()=>{
				...
				fetch('https://3001-4geeksacade-reactflaskh-ltnz14kay5a.ws-us77.gitpod.io/api/protected',{
				method: 'GET',
				mode: 'cors',
				headers:{ 
					"Content-Type": "application/json",
			...
			registrar:(email,password)=>{
				fetch('https://3001-4geeksacade-reactflaskh-ltnz14kay5a.ws-us77.gitpod.io/api/create_user',{
					method:'POST',
					headers:{
						'Content-Type':'application/json',
					},
